...
vocab_file = open('IMDB_vocab_refined.txt',"w")  
...
dataset_path={
    ...
    "IMDB Training":{
        ...
        "Dataset":"IMDB-train-refined.txt"
    },
    "IMDB Validation":{
        "Raw":"raw_IMDB-valid.txt",
        "Dataset":"IMDB-valid-refined.txt",
    },
    "IMDB Test":{
        "Raw":"raw_IMDB-test.txt",
        "Dataset":"IMDB-test-refined.txt",
    }
}
for setType in dataset_path:
    print("Processing",setType)
    rawdatafile = open(dataset_path[setType]["Raw"],"r")    
    datasetfile = open(dataset_path[setType]["Dataset"],"w") 
